...
export default function AdminOrdersPage() {
  ...
  const approveMutation = useApproveOrderAdmin();
  const rejectMutation = useRejectOrderAdmin();
                ...
                {selectedOrder.status === "PENDING" && (
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <FiCheck />{" "}
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <FiXMark />{" "}
